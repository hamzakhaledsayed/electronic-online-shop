	...
	<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
		...
		<ol class="carousel-indicators">
			...
			<?php
								...
								$db=new Database();
								$rs=$db->GetData("select * from adevertising where enddate > now()");
		...
		<?php
								...
								{
							?>
			<div class="carousel-item slider" style="background:url('../shop/images/Ads/<?php echo $row["adsno"] ?>.jpg')  no-repeat center">
				<div class="container">
					<div class="w3l-space-banner">
						<div class="carousel-caption p-lg-5 p-sm-4 p-3">
